...
public class FareCalculatorServiceTest {
    ...
    public void calculateFareBike(){
     ...
     // An exception is raised when parking type is null(neither bike nor car)
    @Test
    public void calculateFareUnkownType(){
       ...
       // when outTime date is before inTime date we expect an illegalArgumentException
    @Test
